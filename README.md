...
3. **The Hunters:** Beneath the surface, there are creatures that can't see but track your sound. Every ping you send is a beacon for them.
4. **Objective:** Descend into the breach, recover the "Origin Core," and reach the extraction rig.

## 🛠️ Technical Stack
- **Framework:** React + Vite
- **UI:** Tailwind CSS + Framer Motion (High-tech HUD)
- **Engine:** Custom HTML5 Canvas (Optimized for wave physics)
- **Logic:** TypeScript
